...
import logoCart from './assets/food.png';
            ...
            <div className="container-fluid">
               <div className="row">
                  <div className="col-md-8">
                     {/* Header */}
                     <div className="row navbar-light bg-white shadow p-3">
                        <div className="col-1">
                     ...
                     <div className="row">
                        {/* left sidebar */}
                        <div className="col-lg-1 bg-white shadow">
                  ...
                  <div className="col-md-4 border-left border-top">
                     <div className="row navbar-light bg-white p-3 border-bottom">
                        <div className="col text-center">
                           <h4 className="">Cart <span className="badge badge-pill badge-info">0</span></h4>
